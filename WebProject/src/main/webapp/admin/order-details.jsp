          ...
          <div>
            ...
            <div class="order_data_panel">
              ...
              <div class="order_data_col_container">
                ...
                <div class="order_data-col">
                  <h3>Thanh Toán</h3>
                  <p>
                    Nguyen Khanh Duy, đại học nông lâm,112,khu thực nghiệm thú y
                  </p>
                  <br />
                  ...
                  <a href="tel:+8469104353">0869104353</a>
                </div>
                ...
                <div class="order_data-col">
                  ...
                  <br />
                  <p class="note">Gan duong so 17</p>
                </div>
              </div>
            </div>
            <div class="order_items-wrapper">
              <table class="order_items">
                ...
                <tbody class="order_shopping_line_item">
                  <tr class="shipping">
                    <td class="thumb">
                      <img
                    ...
                    <td class="name">COD</td>
                    <td></td>
                    <td>30000</td>
                  </tr>
                </tbody>
                <tbody class="order_all_total">
                  <tr>
                    <td></td>
                    <td></td>
                    <td></td>
