...
<head>
    ...
    <link rel="stylesheet" href="./style/infostore.css" />
                ...
                <div class="new_product">
                    <div class="form">
                        <div class="form_group">
                            <label for="product_name shop_name">Tên cửa hàng</label><br />
                            <input
                                    required
                                    type="text"
                                    class="form_control"
                        ...
                        <div class="form_group">
                            <label for="product_price shop_address">Địa chỉ</label><br />
                            <input
                                    required
                                    type="text"
                                    class="form_control"
                        ...
                        <div class="form_group">
                            <label for="product_price shop_email">Email</label><br />
                            <input
                                    required
                                    type="email"
                                    class="form_control"
                        ...
                        <div class="form_group">
                            <label for="product_price shop_slogan">Slogan</label><br />
                            <input
                                    required
                                    type="text"
                                    class="form_control"
                    ...
                    <div class="select_group">
                        ...
                        <div class="display_img">
                            <img alt="vui lòng chọn logo cho cửa hàng" id="review_product-imglogo" />
                        </div>
                        <div class="save_post">
                            <div>
...
<script>
    ...
    const logoImg = document.getElementById("product_imglogo");
    const previewLogoImg = document.getElementById("review_product-imglogo");
    logoImg.addEventListener("change", (e) => {
